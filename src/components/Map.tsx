...
export default function Map({
  ...
  return (
    <div className="relative w-full h-full rounded-2xl overflow-hidden border border-slate-800 bg-[#082f49]">
      ...
      {interactive && (
        <div className="absolute top-2 right-2 left-2 z-[500] pointer-events-none flex justify-center">
          <span className="bg-[#0c4a6e]/90 backdrop-blur-md text-slate-200 text-[11px] px-3 py-1.5 rounded-full border border-sky-700/60 shadow-lg">
      ...
      <button
        ...
        onClick={locateNow}
        disabled={locating}
        className="absolute top-2 left-2 z-[500] bg-[#0c4a6e]/90 hover:bg-[#0369a1] text-white px-2.5 py-2 rounded-xl border border-sky-700/70 shadow-xl backdrop-blur-md flex items-center gap-1.5 text-[11px] active:scale-95 transition-all"
      >
      ...
      <div className="absolute bottom-2 right-2 left-2 z-[500] bg-[#0c4a6e]/90 backdrop-blur-md border border-sky-800/70 p-2 rounded-xl flex items-center justify-between text-[12px] text-white shadow-lg pointer-events-none">
