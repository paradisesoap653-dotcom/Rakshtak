...
// حدود خطأ خاصة بصفحة السائق: تعرض تفاصيل الخطأ الحقيقية بدل الشاشة البيضاء العامة
export default function DriverError({
  ...
  useEffect(() => {
    // نطبعه كمان في الكونسول لتسهيل النسخ
    console.error("Driver page crashed:", error);
  }, [error]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#082f49] via-[#0c4a6e] to-[#0369a1] text-slate-100 p-4 flex flex-col items-center justify-center gap-4">
      <div className="w-full max-w-xl bg-[#0c4a6e] border border-red-500/40 rounded-2xl p-5 space-y-4 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-lg font-bold text-red-400">حصل خطأ في صفحة السائق</h2>
